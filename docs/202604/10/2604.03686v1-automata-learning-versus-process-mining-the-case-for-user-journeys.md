...
## 摘要
随着商业的服务化，了解用户如何体验服务已成为企业成功的关键因素。因此，有必要将用户体验的反馈纳入软件工程过程中。用户旅程的行为模型描述了用户如何体验与服务的交互，能够提供洞察并有望改进服务。在本文中，我们研究了从事件日志中记录的用户与服务交互中自动生成行为模型的技术。我们首先比较了两种从给定事件日志生成行为模型的成熟技术：自动机学习和过程挖掘。随后，我们提出了一种结合了自动机学习和过程挖掘方法的新型混合方法，以克服各自的局限性。针对现有技术，我们提出了学习用户旅程模型的方法，并评估了所得模型的准确性。然后，我们将这些技术与我们从数字服务事件日志中自动提取用户旅程模型的新方法进行了比较。我们通过评估实际应用来评估所有技术的实际适用性。我们的结果表明，过程挖掘技术依赖于专家知识，而自动机学习技术则取决于给定事件日志中事件的分布。我们进一步表明，所提出的混合技术结合了过程挖掘和自动机学习的优势，能够针对给定的事件日志自动选择最佳方法和参数设置，从而学习到非常准确的模型。
