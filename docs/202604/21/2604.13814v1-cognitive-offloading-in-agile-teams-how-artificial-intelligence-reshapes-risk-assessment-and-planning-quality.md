...
## 摘要
人工智能（AI）的最新进展在自动化敏捷项目管理的关键环节方面展现出巨大潜力，但其对团队认知的影响仍有待深入研究。在本研究中，我们通过一项受控的三条件实验，调查了敏捷冲刺规划中的认知卸载现象。该实验在一家中型数字化代理机构的真实客户交付项目中，对比了纯AI、纯人工以及混合规划模型。我们利用定量指标（包括估算准确度、返工率和范围变更恢复时间）以及规划稳健性的定性指标，评估了各模型在纯效率之外的有效性。研究发现，虽然纯AI规划能最大限度地减少时间和成本，但由于存在未说明的假设，它显著降低了风险捕捉率并增加了返工；相比之下，纯人工规划在适应性方面表现出色，但会产生巨大的开销。基于这些发现，我们提出了一个AI-人混合冲刺规划的理论框架，该框架将算法工具分配给估算和待办事项列表格式化任务，同时要求在风险评估和歧义消除方面进行人工审议。我们的研究结果挑战了“效率等同于有效性”的假设，为寻求增强而非削弱团队认知的组织提供了可操作的治理策略。
