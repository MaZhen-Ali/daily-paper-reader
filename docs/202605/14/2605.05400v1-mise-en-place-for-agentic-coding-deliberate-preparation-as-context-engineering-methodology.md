...
tags: ["query:re-us"]
score: 7.0
evidence: 智能体编程的协作规范与上下文衔接
tldr: 本研究针对当前AI编程中过度追求速度而忽视准备的“氛围编程”现状，提出了名为MEP（准备就绪）的上下文工程方法论。该方法借鉴烹饪理念，通过上下文落地、协作规范和任务分解三个阶段，将人类的隐性知识转化为结构化文档。实验证明，充分的准备能显著提升AI智能体的开发效率，减少调试成本，并提出了“上下文流利度”这一开发者核心新技能。
source: arxiv
...
motivation: 针对AI编程智能体因缺乏充分上下文而导致代码质量低、调试成本高的问题，寻求一种系统化的准备方法。
method: 提出MEP三阶段方法论，包括将领域知识外部化、通过人机对话生成详细设计，以及将规范分解为依赖明确的任务记录。
result: 在黑客松比赛中，仅需两小时的准备工作即可支持多个AI智能体并行开发出完整的全栈教育平台。
conclusion: 开发者应培养“上下文流利度”技能，通过结构化准备将AI辅助开发从盲目尝试转向高效的精准执行。
---
